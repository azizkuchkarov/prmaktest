  ...
  return (
    <section id="boshlash" className="pb-20 pt-4 sm:pb-24 sm:pt-6">
      <motion.div
        ...
        className="mx-auto max-w-6xl pad-x-page"
      >
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-blue-500 to-teal-500 px-4 py-12 text-center shadow-2xl shadow-blue-500/25 sm:px-12 sm:py-16">
          <div
          ...
          <p className="relative mx-auto mt-5 max-w-2xl text-pretty text-base leading-relaxed text-blue-50 sm:text-lg">
            Testlar, reyting, tahlil va ota-ona monitoringi orqali tayyorgarlik jarayonini aniq va
            samarali boshqaring.
          </p>
          <div className="relative mt-10">
            <Link
              href={href}
              className="group inline-flex min-h-12 w-full max-w-xs items-center justify-center gap-2 rounded-full bg-white px-8 py-3.5 text-base font-semibold text-blue-700 shadow-lg transition-all hover:gap-3 hover:bg-blue-50 hover:shadow-xl active:scale-[0.98] sm:min-h-0 sm:w-auto sm:max-w-none"
            >
              Boshlash
